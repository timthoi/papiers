...
* @subpackage	Classes
*/
class PapiersdefamillesModelCategories extends PapiersdefamillesClassModelList
{
	/**
	...
	*/
	protected function prepareQuery(&$query)
	{
		...
		switch($this->getState('context', 'all'))
		{
			...
			case 'categories.modal':

				// BASE FIELDS
				$this->addSelect(	'a.subscriptionplan');
		...
		// WHERE - SEARCH : search_search : search on Name + Alias + subscriptionplan > Name
