...
* @subpackage	Classes
*/
class PapiersdefamillesModelCountry extends PapiersdefamillesClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getTable($type = 'country', $prefix = 'PapiersdefamillesTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_papiersdefamilles.edit.country.data', array());
	...
	*/
	protected function prepareQuery(&$query, $pk)
	{
		...
		// FROM : Main table
		$query->from('#__papiersdefamilles_countries AS a');
