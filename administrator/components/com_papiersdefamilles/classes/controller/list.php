...
* @subpackage	
*/
class PapiersdefamillesClassControllerList extends JControllerAdmin
{
	/**
	...
	*/
	public function getModel($name = '', $prefix = 'PapiersdefamillesModel', $config = array('ignore_request' => true))
	{
		if (empty($name))
		{
