...
* @subpackage	Classes
*/
class PapiersdefamillesModelContinent extends PapiersdefamillesClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'continent', 'STRING');
	}
	...
	*/
	public function getTable($type = 'continent', $prefix = 'PapiersdefamillesTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_papiersdefamilles.edit.continent.data', array());
		...
		if (empty($data)) {
			...
			if ($this->getState('continent.id') == 0)
			{
				$jinput = JFactory::getApplication()->input;
	...
	* @param	integer	$pk	The primary id key of the continent
	*
	* @return	void
	*/
	protected function prepareQuery(&$query, $pk)
	{
		...
		// FROM : Main table
		$query->from('#__PAPIERSDEFAMILLES_continents AS a');
