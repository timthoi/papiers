...
/**
* Ajax Class for Papiersdefamilles.
*
* @package	Papiersdefamilles
* @subpackage	Class
*/
class PapiersdefamillesClassAjax extends JObject
{
	/**
	...
	*/
	public static function responseHook($options = array(), $version)
	{
		...
		switch(strtoupper($options['renderExceptions']))
		{
			...
			case 'HTML':
				$return->transaction->htmlExceptions = PapiersdefamillesClassView::renderMessages('HTML');
				break;

			case 'TEXT':
				$return->transaction->rawExceptions = PapiersdefamillesClassView::renderMessages('TEXT');
				break;
			...
			default:
				...
				else
				{
					...
					$return->transaction->exceptions = PapiersdefamillesClassView::renderMessages(null);
