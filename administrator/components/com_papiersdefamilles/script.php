...
/**
* Script file of Papiersdefamilles component
*
* @package	Papiersdefamilles
* @subpackage	Installer
*/
class com_papiersdefamillesInstallerScript
{
	/**
	...
	*/
	...
	{
		$adapter->getParent()->setRedirectURL('index.php?option=com_papiersdefamilles');
	...
	*/
	public function postflight($type, JAdapterInstance $adapter)
	{
		...
		$txtComponent = JText::_('com_papiersdefamilles');
