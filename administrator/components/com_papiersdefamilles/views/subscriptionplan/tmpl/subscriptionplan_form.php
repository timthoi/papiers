...
<?php $fieldSet = $this->form->getFieldset('subscriptionplan.form');?>
<fieldset class="fieldsform form-horizontal">
    ...
    <?php
    // type_subscription_plans
    $field = $fieldSet['jform_type_subscription_plans'];
    $field->jdomOptions = array(
        'list' => PapiersdefamillesHelperEnum::_('type_subscription_plans')
    );
    ?>
    <div class="control-group <?php echo 'field-' . $field->id . $field->responsive; ?>">
        <div class="control-label">
