...
class PapiersdefamillesViewReservations extends PapiersdefamillesClassView
{
	...
	*/
	protected function displayDefault($tpl = null)
	{
		...
		// FILTERs
		// Ticket Type > Num ID
		$modelSubscriptionplan = CkJModel::getInstance('subscriptionplans', 'PapiersdefamillesModel');
        $modelSubscriptionplan->set('context', $model->get('context'));
		$filters['filter_subscriptionplan_id']->jdomOptions = array(
			'list' => $modelSubscriptionplan->getItems()
		);

        // Filters
        // User > Name
       /* $modelUserId = CkJModel::getInstance('thirdusers', 'RickbuyModel');
        $modelUserId->set('context', $model->get('context'));
        $filters['filter_user_id']->jdomOptions = array(
            'list' => $modelUserId->getItems()
        );*/
