...
* @subpackage	Classes
*/
class PapiersdefamillesModelProvince extends PapiersdefamillesClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'province', 'STRING');
	}
	...
	*/
	public function getTable($type = 'province', $prefix = 'PapiersdefamillesTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_papiersdefamilles.edit.province.data', array());
		...
		if (empty($data)) {
			...
			if ($this->getState('province.id') == 0)
			{
				$jinput = JFactory::getApplication()->input;
	...
	* @param	integer	$pk	The primary id key of the province
	*
	* @return	void
	*/
