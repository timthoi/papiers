...
* @subpackage	Classes
*/
class PapiersdefamillesModelCategory extends PapiersdefamillesClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getTable($type = 'category', $prefix = 'PapiersdefamillesTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_papiersdefamilles.edit.category.data', array());
	...
	*/
	protected function prepareQuery(&$query, $pk)
	{
		...
		// FROM : Main table
		$query->from('#__papiersdefamilles_categories AS a');
    ...
    {
        $result = JFactory::getDbo()->updateObject('#__papiersdefamilles_categories', $object, 'id');
    }
