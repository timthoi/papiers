...
/**
* Papiersdefamilles Typedocuments Controller
*
* @package	Papiersdefamilles
* @subpackage	Typedocuments
*/
class PapiersdefamillesControllerTypedocuments extends PapiersdefamillesClassControllerList
{
	/**
	...
	* @var string
	*/
	protected $context = 'typedocuments';
