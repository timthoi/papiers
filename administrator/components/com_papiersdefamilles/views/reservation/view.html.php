...
class PapiersdefamillesViewReservation extends PapiersdefamillesClassView
{
	...
	*/
	protected function displayReservation($tpl = null)
	{
        ...
        $modelDocuments = CkJModel::getInstance('Documents', 'PapiersdefamillesModel');
        $modelDocuments->addGroupOrder("a.num_id");
        $lists['fk']['document_id'] = $modelDocuments->getItems();
		...
		$lists['fk']['subscriptionplan_id'] = $modelSubscriptionplan->getItems();
