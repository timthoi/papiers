...
class JFormFieldModel extends JFormFieldGroupedList
{
	...
	*/
	protected function getGroups()
	{
		...
		$listGroups = PapiersdefamillesHelperForm::getElementGroups($this->element);
		...
		$items = PapiersdefamillesHelperForm::getItems($this);
		...
		foreach($items as $item)
		{
			...
			{
				$val = PapiersdefamillesHelper::parseValue($item, $labelKey);
				if ($val !== null)
	...
	*/
	protected function getOptions()
	{
		...
		if (!empty($items))
		foreach ($items as $item)
			$options[$item->$listKey] = PapiersdefamillesHelper::parseValue($item, $labelKey);
	...
	*/
	public function prepareModel(&$model)
	{
		...
		$groups = PapiersdefamillesHelperForm::getElementGroups($this->element);
