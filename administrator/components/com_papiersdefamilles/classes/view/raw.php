...
/**
* HTML Raw View class for the Papiersdefamilles component
*
* @package	Papiersdefamilles
* @subpackage	Class
*/
class PapiersdefamillesClassViewRaw extends PapiersdefamillesClassView
{
	/**
	...
	*/
	public function outputField($name)
	{
		...
		JFormHelper::addFormPath(JPATH_PAPIERSDEFAMILLES .'/models/forms');
