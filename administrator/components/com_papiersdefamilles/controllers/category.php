...
/**
* Papiersdefamilles category Controller
*
* @package	Papiersdefamilles
* @subpackage	category
*/
class PapiersdefamillesControllercategory extends PapiersdefamillesClassControllerItem
{
	/**
		...
		switch($this->getLayout() .'.'. $this->getTask())
		{
			case 'default.add':
				$this->applyRedirection($result, array(
					'stay',
					'com_papiersdefamilles.category.category'
				), array(
	...
	public function cancel($key = null)
	{
		...
		switch($this->getLayout() .'.'. $this->getTask())
		{
			case 'category.cancel':
				$this->applyRedirection($result, array(
					'stay',
					'com_papiersdefamilles.categories.default'
				), array(
					'cid[]' => null
				));
				break;
