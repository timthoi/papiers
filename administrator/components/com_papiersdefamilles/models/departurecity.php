...
* @subpackage	Classes
*/
class PapiersdefamillesModelDeparturecity extends PapiersdefamillesClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'departurecity', 'STRING');
	}
	...
	*/
	public function getTable($type = 'departurecity', $prefix = 'PapiersdefamillesTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_papiersdefamilles.edit.departurecity.data', array());
		...
		if (empty($data)) {
			...
			if ($this->getState('departurecity.id') == 0)
			{
				$jinput = JFactory::getApplication()->input;
	...
	* @param	integer	$pk	The primary id key of the departurecity
	*
	* @return	void
	*/
	protected function prepareQuery(&$query, $pk)
	{
		...
		// FROM : Main table
		$query->from('#__PAPIERSDEFAMILLES_departurecities AS a');
